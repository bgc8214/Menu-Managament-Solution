...
module.exports = function(app,passport){
	...
	app.post('/statistics', isLoggedIn, statisticsController.makeStatis);
	...
	app.post('/userAddMeal', dayController.saveIsMeal);

	app.post('/userCheckMeal', dayController.checkIsMeal );
   ...
   // console.log("hihihihi");
	...
	app.get('/mealModify', isLoggedIn, function(req,res){
      dayController.findAllDay(req, res);
   });


   app.post('/mealModify', isLoggedIn, function(req,res){
      dayController.modify(req, res);
   });
