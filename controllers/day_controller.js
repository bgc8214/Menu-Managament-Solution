...
exports.modify = function(req,res){
    ...
    Day.findOne({'date': mealDate }, function (err, docs){
        ...
        docs.morning.mainMenu1 = req.body.morningMenu1;
        docs.morning.mainMenu2 = req.body.morningMenu2;
        docs.morning.mainMenu3 = req.body.morningMenu3;
        docs.morning.mainMenu4 = req.body.morningMenu4;
        docs.morning.mainMenu5 = req.body.morningMenu5;
        docs.morning.sideMenu = req.body.morningSideMenu;

        docs.lunch.mainMenu1 = req.body.lunchMenu1;
        docs.lunch.mainMenu2 = req.body.lunchMenu2;
        docs.lunch.mainMenu3 = req.body.lunchMenu3;
        docs.lunch.mainMenu4 = req.body.lunchMenu4;
        docs.lunch.mainMenu5 = req.body.lunchMenu5;
        docs.lunch.sizdeMenu = req.body.lunchSideMenu;

        docs.dinner.mainMenu1 = req.body.dinnerMenu1;
        docs.dinner.mainMenu2 = req.body.dinnerMenu2;
        docs.dinner.mainMenu3 = req.body.dinnerMenu3;
        docs.dinner.mainMenu4 = req.body.dinnerMenu4;
        docs.dinner.mainMenu5 = req.body.dinnerMenu5;
        docs.dinner.sideMenu = req.body.dinnerSideMenu;
...
exports.findAllDay = function(req, res){
    ...
    var data;
    Day.find({'date' : new RegExp(query, 'i')}, function (err, result) {
        if (err) {
            console.log(err);
            return console.log("detail not find");
        }
        ...
        res.render('mealModify.ejs', { mealData: result});
    });
